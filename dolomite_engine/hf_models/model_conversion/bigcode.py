...
def _import_config_from_huggingface(original_config: GPTBigCodeConfig) -> SBDolomiteConfig:
...
def export_to_huggingface_bigcode(pretrained_model_name_or_path: str, save_path: str) -> None:
    ...
    config: SBDolomiteConfig = AutoConfig.from_pretrained(save_path)
...
def _export_config_to_huggingface(config: SBDolomiteConfig) -> GPTBigCodeConfig:
