...
class ColumnScatterParallelLinear(ParallelExperts):
    def __init__(
        self,
        num_experts: int,
        in_features: int,
        ...
        self.weight = self.weight.to(dtype=dtype, device=device)
...
class ColumnScatterParallelLinear(ParameterizedLinear):
    def __init__(
        self,
        in_features: int,
        out_features: int,
